...
const uri = 'mongodb+srv://nam1911:e5CFam5EjP5EviYp@namah.n4rgsdo.mongodb.net/md18306';
...
//     console.log(`Example app listening on port ${port}`);
// });
// const uri = 'mongodb+srv://<nam2702 >:<Dangnam18032004>@namah.n4rgsdo.mongodb.net/md18306';
// const mongoose = require('mongoose');
// const CarModel = require('./carModel');
// app.get('/', async (req, res)=>{
//     await mongoose.connect(uri);
